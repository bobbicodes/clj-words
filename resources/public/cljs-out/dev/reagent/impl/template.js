...
var G__10153 = o;
(G__10153[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__10157 = o;
(G__10157[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__10159__i < G__10159__a.length) {G__10159__a[G__10159__i] = arguments[G__10159__i + 0]; ++G__10159__i;}
  args = new cljs.core.IndexedSeq(G__10159__a,0,null);
} 
...
var G__10162 = props;
var G__10162__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10162,cljs.core.cst$kw$id,id):G__10162);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10162__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__10163){
...
var props = map__10164__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10164__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__10164,map__10164__$1,props,class$){
return (function (c){
...
});})(map__10164,map__10164__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10166){
var map__10167 = p__10166;
var map__10167__$1 = ((((!((map__10167 == null)))?(((((map__10167.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10167.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10167):map__10167);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10167__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__10167,map__10167__$1,on_write){
return (function (){
...
});})(node_value,map__10167,map__10167__$1,on_write))
);
} else {
...
var G__10170 = jsprops;
(G__10170["defaultValue"] = value);

(G__10170["onChange"] = ((function (G__10170,v,value,on_change){
return (function (p1__10169_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10169_SHARP_);
});})(G__10170,v,value,on_change))
);
...
var vec__10173 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10173,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10173,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10173,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___10177 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___10177 == null)){
} else {
var key_10178 = temp__5461__auto___10177;
(jsprops["key"] = key_10178);
}
...
var temp__5461__auto___10179 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___10179 == null)){
} else {
var key_10180 = temp__5461__auto___10179;
reagent.impl.template.oset(jsprops,"key",key_10180);
}
...
var G__10181 = reagent.impl.template.__GT_NativeWrapper();
(G__10181["name"] = c);
...
var G__10182 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10182) : reagent.impl.template.as_element.call(null,G__10182));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10185){
var G__10186 = cljs.core.first(seq10185);
var seq10185__$1 = cljs.core.next(seq10185);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10186,seq10185__$1);
});
...
break;
default:
var G__10192 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__10192;
continue;
...
var n__4408__auto___10194 = a.length;
var i_10195 = (0);
while(true){
if((i_10195 < n__4408__auto___10194)){
(a[i_10195] = reagent.impl.template.as_element((a[i_10195])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___10197 = a.length;
var i_10198 = (0);
while(true){
if((i_10198 < n__4408__auto___10197)){
var val_10199 = (a[i_10198]);
if(((cljs.core.vector_QMARK_(val_10199)) && ((reagent.impl.template.key_from_vec(val_10199) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10198] = reagent.impl.template.as_element(val_10199));
...
var ctx = ({});
var vec__10201 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10201,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10201,(1),null);
...
var G__10204 = (cljs.core.count(argv) - first_child);
switch (G__10204) {
case (0):
...
case (1):
var G__10205 = comp;
var G__10206 = jsprops;
var G__10207 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__10205,G__10206,G__10207) : reagent.impl.template.global$module$react.createElement.call(null,G__10205,G__10206,G__10207));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__10204){
