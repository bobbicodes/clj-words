...
if((i < len)){
var k = (ks[i]);
var G__10030 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__10031 = (i + (1));
m = G__10030;
i = G__10031;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__10032 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__10032) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__10032));
})());
} else {
var v = temp__5459__auto__;
...
return (G__10034__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__10036 = c;
var G__10036__$1 = (((G__10036 == null))?null:G__10036.prototype);
if((G__10036__$1 == null)){
return null;
} else {
return (G__10036__$1["render"]);
}
})() == null))));
});
...
var G__10038 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__10038) : reagent.impl.component.as_element.call(null,G__10038));
};
...
var _STAR_current_component_STAR_10044 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_10044;
}});
...
return ((function (G__10045,G__10045__$1){
...
var c = this;
var G__10050_10052 = (c["cljsRatom"]);
if((G__10050_10052 == null)){
} else {
reagent.ratom.dispose_BANG_(G__10050_10052);
}
...
var renders_10054 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_10055 = cljs.core.first(cljs.core.vals(renders_10054));
if((cljs.core.count(renders_10054) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_10054))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_10055)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_10055], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__10053 = name;
switch (G__10053) {
case "":
...
var G__10058 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__10058) : reagent.impl.component.global$module$create_react_class.call(null,G__10058));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__10059 = fiber;
var G__10059__$1 = (((G__10059 == null))?null:(G__10059["type"]));
if((G__10059__$1 == null)){
return null;
} else {
return (G__10059__$1["displayName"]);
}
})();
var parent = (function (){var G__10060 = fiber;
if((G__10060 == null)){
return null;
} else {
return (G__10060["return"]);
}
})();
var path = (function (){var G__10061 = parent;
var G__10061__$1 = (((G__10061 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__10061) : reagent.impl.component.fiber_component_path.call(null,G__10061)));
if((G__10061__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10061__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__10063 = c;
if((G__10063 == null)){
return null;
} else {
return (G__10063["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__10064._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__10066 = c;
if((G__10066 == null)){
return null;
} else {
...
var or__3949__auto____$1 = (function (){var G__10068 = c;
if((G__10068 == null)){
return null;
} else {
return G__10068._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__10070 = instance;
if((G__10070 == null)){
return null;
} else {
return (G__10070["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__10071 = instance;
if((G__10071 == null)){
return null;
} else {
return G__10071._currentElement;
}
}
})();
var name = (function (){var G__10072 = elem;
var G__10072__$1 = (((G__10072 == null))?null:(G__10072["type"]));
if((G__10072__$1 == null)){
return null;
} else {
return (G__10072__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__10074 = elem;
if((G__10074 == null)){
return null;
} else {
return (G__10074["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__10075._owner;
}
}
})();
var path = (function (){var G__10076 = owner;
var G__10076__$1 = (((G__10076 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__10076) : reagent.impl.component.component_path.call(null,G__10076)));
if((G__10076__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10076__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__10077 = c;
var G__10077__$1 = (((G__10077 == null))?null:G__10077.constructor);
if((G__10077__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__10077__$1);
}
}
})();
